...
const NavbarModerator = () => {
  const navigation = [
    {
      name: "Home",
      href: routesFrontend.ModeratorHome,
      // current: true
    },
    {
      name: "Tickets",
    ...
    {
      name: "Mentees List",
      href: routesFrontend.MenteesList,
      // current: false
    },
    {
      name: "Mentors List",
      href: routesFrontend.MentorsList,
      // current: false
    },
    {
      name: "Mentor Applicants",
      href: routesFrontend.MentorApplicants,
      // current: false
    },
