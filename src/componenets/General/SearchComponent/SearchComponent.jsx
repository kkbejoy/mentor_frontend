    ...
    <>
      <form className="mx-0 md:mx-14 my-14 drop-shadow-lg text-center hover:shadow-yellow-100">
        <input
          ...
          className=" py-3 px-4 text-center text-lg w-4/5 md:w-2/5 placeholder-textHeadline placeholder:font-semibold pr-10 sm:text-sm  rounded-md focus:text-left focus:border-collapse focus:bg-cardsBG"
          type="search"
